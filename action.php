    ...
    //if(isset($_POST["submit"])) {
        ...
        if(isse($_SESSION["email"]) && isset($_SESSION["password"])) {
            ...
            if(empty($_SESSION["password"])) {
                header("Location: ./login_org.php?error1=Email field is required!");
            }
            else if(empty($_SESSION["password"])) {
                header("Location: ./login_org.php?error2=Password field is required!");
            }
            else {
                ...
                if(mysqli_num_rows($res) == 1) {
                    ...
                    header("Location: ./login_org.php?error2=Invalid username or password!");
                }
